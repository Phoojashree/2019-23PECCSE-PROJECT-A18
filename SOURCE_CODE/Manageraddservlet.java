...
public class Manageraddservlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.print("fkey: "+fkey);
		
		String fcateg=request.getParameter("category");
		System.out.print("fcateg: "+fcateg);
		
		String ffile=request.getParameter("files");
		System.out.print("file: "+ffile);
		
		String fprior=request.getParameter("priority");
		System.out.print("fprior: "+fprior);
		
		String fdescrip=request.getParameter("description");
		System.out.print("fdescrip: "+fdescrip);
...
MultipartParser mp =new MultipartParser(request, 999999999);
		...
		String fullpath=editpath+"Ipspoof\\WebContent\\Local\\";
	...
	//file encrypted and store into filepath1
             ...
             filepath1 = editpath + "\\Ipspoof\\WebContent\\Encrypt\\"+filename;
              ...
              //file decrypted and store into filepath2
        		    ...
        		    filepath2 = editpath + "\\Ipspoof\\WebContent\\Decrypt\\"+filename;
     ...
     filepath1 = editpath + "\\Ipspoof\\WebContent\\Encrypt\\"+filename;
      ...
      //file decrypted and store into filepath2
			...
			/*up.setFileowner(oname);
            System.out.println("B1:"+oname);*/
            
            /*up.setBranch(paramValues.get(0).toString());
            System.out.println("Brname:"+paramValues);
            */ 
           up.setFilename(filename);
			...
			//up.setFilename(fname);
			//up.setFilekey(fkey);
			//up.setFilecateg(fcateg);
			//up.setFiles(ffile);
			//up.setFileprior(fprior);
			//up.setFiledescript(fdescrip);
            ...
            up.setFilecateg(paramValues.get(2).toString());
            System.out.println("Category: "+fcateg);
            
            up.setFileprior(paramValues.get(4).toString());
            System.out.println("Priority: "+fprior);
            
          Inter r=new Imple();
            int m=r.uploadinter2(up);
            if(m==1)
            {
