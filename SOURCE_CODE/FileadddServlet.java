...
/**
 * Servlet implementation class FileadddServlet
 */
@WebServlet("/FileadddServlet")
public class FileadddServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FileadddServlet() {
        super();
     ...
     filepath1 = editpath + "\\ipspoof\\WebContent\\Encrypt\\"+filename;
      ...
      //file decrypted and store into filepath2
			...
			String aphas=secondBlock.hash;
			  ...
			  up.setTitle(paramValues.get(0).toString());
            System.out.println("Category: "+paramValues.get(0));
            
            
          up.setDescription(paramValues.get(2).toString());
          System.out.println("des: "+paramValues.get(2));
          
          up.setS1mail(paramValues.get(4).toString());
