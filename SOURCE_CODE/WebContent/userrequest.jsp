...
<li><a href="ownermainpage.jsp">Logout</a></li>
 ...
 -->
<div class="backtag">
<a href="staffmainpage.jsp">Back</a>
</div>
...
<%	
	...
	%>
     ...
     <td><%=rp.getString(7) %></td>
      ...
      <td><%=categlist %> </td>      
      <td><%=priorlist %> </td>
      <td><a href="staffrequestjava.jsp?emaill=<%=emails %>&&ipaddl=<%=ipadds %>&&fnamel=<%=fnamelist%>&&fkeyl=<%=fkeylist%>&&fcategl=<%=categlist%>&&fpriorl=<%=priorlist%>">Request</a></td>
       </tr>
